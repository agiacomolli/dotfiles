...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Comment ctermbg=NONE ctermfg=4 cterm=bold guibg=NONE guifg=#005faf gui=bold
    ...
    hi Statement ctermbg=NONE ctermfg=47 cterm=bold guibg=NONE guifg=#00ff00 gui=bold
    hi String ctermbg=NONE ctermfg=208 cterm=NONE guibg=NONE guifg=#f57800 gui=NONE
    hi Todo ctermbg=11 ctermfg=0 cterm=NONE guibg=#ea00d9 guifg=NONE gui=NONE
    ...
    hi LineNr ctermbg=NONE ctermfg=23 cterm=NONE guibg=NONE guifg=#005faf gui=NONE
