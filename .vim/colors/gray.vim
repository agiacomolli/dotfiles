...
hi ColorColumn ctermbg=3 ctermfg=240 cterm=bold
hi DiffAdd ctermbg=12
hi SpellBad ctermbg=93 ctermfg=15 cterm=bold
...
"hi      Constant     guifg=NONE     guibg=NONE    ctermfg=NONE   ctermbg=NONE gui=bold cterm=bold
...
"hi      Keyword      guifg=#6c6c6c guibg=#262626 ctermfg=250  ctermbg=NONE gui=bold cterm=bold
